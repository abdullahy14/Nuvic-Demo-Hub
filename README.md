...
- TypeScript
- Tailwind CSS
- `next/image` for all local project-hosted images
...
- Nuvic Library image paths: `components/Gallery.tsx`
- Core Engine banner path: `app/nuvic-hub-demo-map/page.tsx`
- Hosted image assets: `public/images/*`
